    ...
    (() => {
        ...
        function menuInit() {
            if (document.querySelector(".icon-menu")) document.addEventListener("click", (function(e) {
                if (document.documentElement.classList.contains("menu-open") && !e.target.closest(".menu__body")) {
                    bodyLockToggle();
            ...
            window.addEventListener("load", (function(e) {
                ...
                function getHeight(showMoreBlock, showMoreContent) {
                    ...
                    if ("items" === showMoreType) {
                        ...
                        for (let index = 1; index < showMoreItems.length + 1; index++) {
        ...
        const sliders = document.querySelectorAll(".main-catalog-filters__slider");
        if (sliders) for (let index = 0; index < sliders.length; index++) {
            const slide = sliders[index];
            const slides = slide.nextElementSibling.querySelectorAll(".main-catalog-filters__block");
            slide.classList.add(`slider-id-${index}`);
            slide.querySelector(".swiper-wrapper").classList.add(`slider-wrapper-id-${index}`);
            slides.forEach((item => {
                item.setAttribute("data-da", `.slider-wrapper-id-${index}, 1023.98, 1`);
            }));
        }
        function initSliders() {
            ...
            if (sliders) for (let index = 0; index < sliders.length; index++) {
                sliders[index];
                new core(`.main-catalog-filters__slider.slider-id-${index}`, {
                    slideClass: "main-catalog-filters__block",
                    ...
                    speed: 800,
                    pagination: {
                        el: `.main-catalog-filters__slider.slider-id-${index} .swiper-pagination`,
                        clickable: true
                    },
                    navigation: {
                        prevEl: ".swiper-button-prev",
        ...
        const lazyMedia = new lazyload_min({
            elements_selector: "[data-src],[data-srcset],[data-bg-set]",
...
***************************************************************************** */
        ...
        function documentActions(e) {
            const el = e.target;
            if (el.closest(".catalog-menu__link")) {
                const submenu = document.querySelector(".catalog-submenu._active");
                const button = el.closest(".catalog-menu__link");
                const activeButton = document.querySelector(".catalog-menu__link._active");
            ...
            if (!el.closest(".catalog-menu__link") && !el.closest(".catalog-submenu")) {
                const submenu = document.querySelector(".catalog-submenu._active");
                const activeButton = document.querySelector(".catalog-menu__link._active");
                if (submenu) submenu.classList.remove("_active");
                if (activeButton) activeButton.classList.remove("_active");
            }
            if (el.closest(".header-quiz__menu-button")) {
                const button = el.closest(".header-quiz__menu-button");
                const activeButton = document.querySelector(".header-quiz__menu-button._active");
                const submenu = document.querySelector(".header-quiz-form._active");
                if (activeButton && activeButton !== button) {
                    activeButton.classList.remove("_active");
                    if (submenu) submenu.classList.remove("_active");
                }
            ...
            if (el.closest(".header-quiz__button")) {
                const button = el.closest(".header-quiz__button");
                const activeButton = document.querySelector(".header-quiz__menu-button._active");
                const submenu = document.querySelector(".header-quiz-form._active");
                if (activeButton) activeButton.classList.remove("_active");
                if (submenu) submenu.classList.remove("_active");
        ...
        const optionsAutomation = document.querySelectorAll(".products-list-item__automation");
        if (optionsAutomation) optionsAutomation.forEach((item => {
            const inputs = item.querySelectorAll("input");
            let rand = Math.random();
            inputs.forEach((input => {
                input.name = rand;

(() => {
    ...
    (() => {
        ...
        function spollers() {
            ...
            if (spollersArray.length > 0) {
                ...
                function setSpollerAction(e) {
                    ...
                    if (el.closest("[data-spoller-choose]")) {
                        const spollersBlock = el.closest("[data-spollers]");
                        const spollerTitle = spollersBlock.querySelector("[data-spoller]");
                        const oneSpoller = spollersBlock.hasAttribute("data-one-spoller");
                        const spollerSpeed = spollersBlock.dataset.spollersSpeed ? parseInt(spollersBlock.dataset.spollersSpeed) : 500;
                        if (!spollersBlock.querySelectorAll("._slide").length) {
                            if (oneSpoller && !spollerTitle.classList.contains("_spoller-active")) hideSpollersBody(spollersBlock);
        ...
        function formQuantity() {
            ...
            document.addEventListener("click", (function(e) {
                ...
                if (targetElement.closest(".quantity__button")) {
                    ...
                    const block = targetElement.closest("[data-spollers]");
                    let valuePeople = block.querySelector("[data-spoller]");
                    let caunterPeople = document.querySelector(".filter-people__counter");
                    if (targetElement.classList.contains("quantity__button_plus")) value++; else {
                        --value;
                        if (value < 1) value = 1;
                    }
                    targetElement.closest(".quantity").querySelector("input").value = value;
                    valuePeople.innerText = value + " " + declOfNum(value, [ "человек", "человека" ]);
                    caunterPeople.innerText = declOfNum(value, [ "человек", "человека" ]);
                }
            }));
        }
        ...
        function initSliders() {
            ...
            if (document.querySelector(".way-product__slider")) new core(".way-product__slider", {
                modules: [ Navigation, Pagination ],
                observer: true,
                observeParents: true,
                slidesPerView: 1,
                ...
                loop: true,
                pagination: {
                    el: ".way-product__slider-pagination",
                    type: "progressbar"
                },
                navigation: {
                    prevEl: ".way-product__slider-prev",
                    nextEl: ".way-product__slider-next"
                },
                breakpoints: {
                    320: {
                        slidesPerView: 1.2,
...
***************************************************************************** */
        ...
        !function(e, t) {
            ...
            return function(e) {
                ...
                n(1);
                var a = [], r = [ "Вс", "Пн", "Вт", "Ср", "Чт", "Пт", "Сб" ], i = [ "Январ", "Февраль", "Март", "Апрель", "Май", "Июнь", "Июль", "Август", "Сентябрь", "Октябрь", "Ноябрь", "Декабрь" ], s = {
                    t: "top",
                    r: "right",
                    b: "bottom",
                    l: "left",
                ...
                e.exports = function(e, t) {
                    ...
                    var n = function(e, t) {
                        ...
                        var v = {
                            ...
                            overlayPlaceholder: l.overlayPlaceholder || "Год",
                            overlayButton: l.overlayButton || "Выбрать",
        ...
        if (document.querySelector(".filter-date-bus")) {
            datepicker(".filter-date-bus", {
        ...
        if (document.querySelector(".filter-date-geep")) {
            datepicker(".filter-date-geep", {
                dateSelected: new Date,
                minDate: new Date,
                showAllDates: true,
                formatter: (input, date, instance) => {
        ...
        if (document.querySelector(".filter-date-ship")) {
            datepicker(".filter-date-ship", {
                dateSelected: new Date,
                minDate: new Date,
                showAllDates: true,
                formatter: (input, date, instance) => {
        ...
        if (document.querySelector(".filter-date-can")) {
            datepicker(".filter-date-can", {
                dateSelected: new Date,
                minDate: new Date,
                showAllDates: true,
                formatter: (input, date, instance) => {
        ...
        var d = date.getDate();
        console.log(d);
        if (document.querySelector(".calendar-product__date")) {
            datepicker(".calendar-product__date", {
                alwaysShow: true,
                startDay: 1,
                showAllDates: true,

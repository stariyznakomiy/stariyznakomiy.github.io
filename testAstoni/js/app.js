(() => {
    ...
    function menuInit() {
        if (document.querySelector(".icon-menu")) document.addEventListener("click", (function(e) {
            ...
            if (bodyLockStatus && !e.target.closest(".icon-menu") && !e.target.closest(".header__content")) {
                bodyUnlock();
        ...
        function formSent(form, responseResult = ``) {
            ...
            setTimeout((() => {
                if (flsModules.popup) {
                    ...
                    popup ? flsModules.popup.openMessage(popup) : null;
                }
            }), 0);
            formValidate.formClean(form);
    ...
    function initSliders() {
        if (document.querySelector(".swiper")) new core(".swiper", {
            ...
            pagination: {
                el: ".hero-navigations__pagination",
                clickable: true
            },
            navigation: {

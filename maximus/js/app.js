 ...
 */
    ...
    (() => {
        ...
        function initSliders() {
            bildSliders();
            if (document.querySelector(".visitors__slider")) new core(".visitors__slider", {
                modules: [ Navigation, Pagination, Grid, Scrollbar ],
                observer: true,
                observeParents: true,
                slidesPerView: 5,
                grid: {
                ...
                speed: 800,
                navigation: {
                    prevEl: ".visitors-arrow_prev",
                    nextEl: ".visitors-arrow_next"
                },
                breakpoints: {
                    320: {
                        slidesPerView: 2,
            ...
            if (document.querySelector(".horses__slider")) new core(".horses__slider", {
                ...
                loop: true,
                navigation: {
                    prevEl: ".horses-arrow_prev",
                    nextEl: ".horses-arrow_next"
                },
                breakpoints: {
                    320: {
                        slidesPerView: 1.15,

    ...
    var followCursor = {
        ...
        fn: function fn(instance) {
            ...
            function onMouseMove(event) {
                ...
                if (isCursorOverReference || !instance.props.interactive) instance.setProps({
                    getReferenceClientRect: function getReferenceClientRect() {
                        ...
                        var x = clientX;
                        var y = clientY;
                        if ("initial" === followCursor) {
                            x = rect.left + relativeX;
                            y = rect.top + relativeY;
                        }
                        var top = "horizontal" === followCursor ? rect.top : y;
                        var right = "vertical" === followCursor ? rect.right : x;
                        var bottom = "horizontal" === followCursor ? rect.bottom : y;
                        var left = "vertical" === followCursor ? rect.left : x;
                        return {
                            width: right - left,
                            height: bottom - top,
                            top,
            ...
            function destroy() {
                ...
                if (0 === activeInstances.filter((function(data) {
                    return data.doc === doc;
                })).length) removeMouseCoordsListener(doc);
            }
            return {
                onCreate: create,
                onDestroy: destroy,
                ...
                onAfterUpdate: function onAfterUpdate(_, _ref2) {
                    ...
                    if (void 0 !== followCursor && prevProps.followCursor !== followCursor) {
                        destroy();
                        if (followCursor) {
                            create();

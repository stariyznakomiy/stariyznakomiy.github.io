 ...
 */
    ...
    (() => {
        ...
        const titles = document.querySelectorAll(".hero-slider__slide-text p");
        const splitText = el => {
        ...
        const textBlocks = document.querySelectorAll(".hero-slider__slide-text");
        let delayStep = .015;
        ...
        function initSliders() {
            ...
            new core(".hero-slider", {
                ...
                on: {
                    init: function(heroSlider) {
                        const activeSlide = heroSlider.slides[heroSlider.realIndex];
                        const text = activeSlide.querySelector(".hero-slider__slide-text");
                        text.classList.add("_active");
                        setTimeout((() => {
                            text.classList.remove("_active");
                        }), 2900);
                    },
                    slideChange: function(heroSlider) {
                        const activeSlide = heroSlider.slides[heroSlider.realIndex];
                        const text = activeSlide.querySelector(".hero-slider__slide-text");
                        text.classList.add("_active");
                        setTimeout((() => {

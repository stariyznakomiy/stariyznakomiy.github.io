    ...
    (() => {
        ...
        function initSliders() {
            if (document.querySelector(".works__slider")) new swiper_core_Swiper(".works__slider", {
                ...
                navigation: {
                    prevEl: ".works__navigation-arrow_prev",
                    nextEl: ".works__navigation-arrow_next"
                },
                on: {}
            });
            if (document.querySelector(".news__slider")) new swiper_core_Swiper(".news__slider", {
                ...
                navigation: {
                    prevEl: ".news__navigation-arrow_prev",
                    nextEl: ".news__navigation-arrow_next"
                },
                breakpoints: {
                    320: {
                        slidesPerView: 1,
            ...
            if (document.querySelector(".job__slider")) new swiper_core_Swiper(".job__slider", {
                modules: [ Navigation, Pagination ],
                observer: true,
                observeParents: true,
                slidesPerView: 3,
                ...
                navigation: {
                    prevEl: ".job__navigation-arrow_prev",
                    nextEl: ".job__navigation-arrow_next"
                },
                breakpoints: {
                    320: {
                        slidesPerView: 1,
        ...
        function catalogInit() {
            const catalogWrapper = document.querySelector("[data-js-catalog]");
            if (catalogWrapper) itemsInit(catalogWrapper);
        }
        function itemsInit(catalogWrapper) {
            const catalogItems = catalogWrapper.querySelectorAll("[data-js-item]");
            const counter = catalogWrapper.dataset.jsCatalog;
            for (let i = 0; i < counter; i++) catalogItems[i].classList.remove("hide");
        }
        catalogInit();
        const script_button = document.querySelector("[data-js-show]");
        if (script_button) script_button.addEventListener("click", (e => {
            const catalogItems = document.querySelectorAll("[data-js-item]");
            if (catalogItems) catalogItems.forEach((item => {
                item.classList.remove("hide");
            }));
            script_button.classList.add("hide");
        }));
        function hideCookies() {
            const cookieWrapper = document.querySelector('[data-js="cookie"]');
            if (cookieWrapper) {
                const button = document.querySelector('[data-js="cookie-button"]');

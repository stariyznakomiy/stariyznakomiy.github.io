    ...
    (() => {
            ...
            if (spollersArray.length > 0) {
                ...
                function setSpollerAction(e) {
                    ...
                    if (el.closest("[data-spoller]")) {
                        ...
                        const spollerWrap = spollerTitle.closest("[data-spoller-wrap]");
                        const oneSpoller = spollersBlock.hasAttribute("data-one-spoller");
                        const spollerSpeed = spollersBlock.dataset.spollersSpeed ? parseInt(spollersBlock.dataset.spollersSpeed) : 500;
                        if (!spollersBlock.querySelectorAll("._slide").length) {
                            if (oneSpoller && !spollerTitle.classList.contains("_spoller-active")) hideSpollersBody(spollersBlock);
                            spollerTitle.classList.toggle("_spoller-active");
                            spollerWrap.classList.toggle("_spoller-active");
                ...
                function hideSpollersBody(spollersBlock) {
                    ...
                    const spollerActiveWrap = spollersBlock.querySelector("[data-spoller-wrap]._spoller-active");
                    const spollerSpeed = spollersBlock.dataset.spollersSpeed ? parseInt(spollersBlock.dataset.spollersSpeed) : 500;
                    if (spollerActiveTitle && !spollersBlock.querySelectorAll("._slide").length) {
                        spollerActiveTitle.classList.remove("_spoller-active");
                        spollerActiveWrap.classList.remove("_spoller-active");
        ...
        function formSubmit() {
            ...
            function formSent(form, responseResult = ``) {
                ...
                form.parentElement.classList.add("_success");
                setTimeout((() => {
                    form.parentElement.classList.remove("_success");
                }), 4e3);
                setTimeout((() => {
                    if (flsModules.popup) {
        ...
        function initSliders() {
            if (document.querySelector(".main-slider__container")) new core(".main-slider__container", {
            ...
            if (document.querySelector(".categories-filter__list")) new core(".categories-filter__list", {
                ...
                freeMode: true,
                navigation: {
                    prevEl: ".categories-filter__arrow-prev",
                    nextEl: ".categories-filter__arrow-next"
                },
                on: {}
            });
            if (document.querySelector(".brands__list")) new core(".brands__list", {
                modules: [ Navigation, freeMode ],
                observer: true,
                observeParents: true,
                slidesPerView: "auto",
        ...
        function clickDocument(e) {
            ...
            if (el.closest(".product-item__favorite-add")) el.closest(".product-item__favorite-add").classList.toggle("_active");
            ...
            if (el.classList.contains("categories-filter__item")) {
                ...
                const products = document.querySelectorAll(".products-collection__item");

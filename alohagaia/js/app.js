(() => {
    ...
    (() => {
        ...
        function initSliders() {
            if (document.querySelector(".product-card-featured__slider")) new swiper_core_Swiper(".product-card-featured__slider", {
                modules: [ Navigation ],
                observer: true,
                observeParents: true,
                slidesPerView: "auto",
        ...
        menuItems.forEach((item => {
            item.addEventListener("mouseover", (event => {
                ...
                if (item.querySelector(".submenu")) document.documentElement.classList.add("menu-open");
            }));
            item.addEventListener("mouseout", (event => {
                item.classList.remove("_active");
                item.closest(".menu__list").classList.remove("_active");
                if (item.querySelector(".submenu")) document.documentElement.classList.remove("menu-open");
            }));
        }));

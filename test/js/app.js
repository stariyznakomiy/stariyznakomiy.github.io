    ...
    (() => {
        ...
        function initSliders() {
            if (document.querySelector(".swiper")) {
                new core(".swiper", {
                    ...
                    on: {
                        afterInit: function(event) {
                            slideIndexFormatter(event.realIndex, ".side__number--current");
                            const totalDiv = document.querySelector(".side__number--total");
                            totalDiv.innerHTML = event.slides.length < 10 ? `0${event.slides.length}` : event.slides.length;
                        },
                ...
                function slideIndexFormatter(slideIndex, selector) {
                    return Object.assign(document.querySelector(selector), {
                        innerHTML: `${slideIndex + 1 < 10 ? `0${slideIndex + 1}` : slideIndex + 1}`
                    });
                }
            }
        }

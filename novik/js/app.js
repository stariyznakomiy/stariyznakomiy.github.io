 ...
 */
 ...
 if (btn_en.classList.contains('switcher__active')){
   for (let i = 0; i < en.length; i++) {
     en[i].classList.toggle("_active");
   }
} 
...
for (let i = 0; i < switcher.length; i++) {
  ...
  btn.addEventListener('click', function (event) {
    for (let i = 0; i < switcher_btn.length; i++) {
      switcher_btn[i].classList.toggle("switcher__active");
    };
    /* for (let i = 0; i < en.length; i++) {
      en[i].classList.toggle("_active");
      ru[i].classList.toggle("_active");
    } */
  });
}
